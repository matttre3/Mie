        ...
        <div className='w-full md:w-3/5 flex flex-col justify-center items-center'>
            ...
            <div className='flex items-center flex-col sm:flex-row pt-6'>
                <div className='flex flex-col justify-center items-center  pl-8 pr-8'>
                    ...
                    <button onClick={() => {navigate("/test");}}  className='font-poppins border-2 border-blue-800 text-blue-800 pl-6 pr-6 p-2 mt-6 rounded-xl hover:bg-blue-800 hover:text-white transition duration-150'>Take the test</button>
                </div>
              ...
              className='font-poppins border-2 border-blue-800 text-blue-800 pl-6 pr-6 p-2 mt-6 rounded-xl hover:bg-blue-800 hover:text-white transition duration-150'>Check a color</button>
                </div>
            </div>
        </div>
        <div className='w-4/5 md:w-2/5 relative overflow-hidden mb-32 sm:mb-0'>
            <img className=" w-3/5 absolute floating bottom-0 right-0" src="/tavolozza.png" alt="" />
            <img src="/phone.png" alt="" />
            <img className="w-3/5 absolute floating top-6 " src="/palette.png" alt="" />
        </div>
    </div>
  )
}
